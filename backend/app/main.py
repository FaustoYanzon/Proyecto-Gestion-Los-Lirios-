...
from app.api import alertas, arca, auth, clima, finanzas, insumos, kpis, notificaciones, parcelas, plan_fitosanitario, precios_tarea, presupuestos, produccion, telefonos_whatsapp, termografo, trabajadores, trazabilidad, users, whatsapp, whatsapp_webhook
...
app.include_router(plan_fitosanitario.router)
